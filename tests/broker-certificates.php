...
if ($target === '--php') {
    ...
    if ($loadedSwoole === '') {
        ...
        expect(is_file($swoole), 'PHP 证书授权验收需要 TYPE_SWOOLE_MODULE 或 extension_dir 中匹配平台的 Swoole 模块');
