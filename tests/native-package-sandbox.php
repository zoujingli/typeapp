...
function linuxPackageCommand(string $root, string $package, array $dataDirectories, ?string $processInfo = null): array
{
    ...
    $preserved = ['APP_BASE_PATH', 'APP_ENV', 'APP_DEBUG', 'APP_CACHE_ENABLED', 'APP_NAME',
        'APP_LISTEN', 'APP_PORT', 'APP_ALLOWED_HOSTS', 'APP_API_TOKEN', 'APP_ADMIN_PASSWORD', 'APP_CUSTOMER_PASSWORD', 'DB_DRIVER', 'DB_HOST', 'DB_PORT', 'DB_DATABASE',
        'DB_USERNAME', 'DB_PASSWORD', 'DB_SQLITE_FILE', 'TYPE_APP_RELEASE_SHA256', 'TYPE_APP_TRACE', 'TYPE_TEMPLATE_EXPECTED_MESSAGE',
