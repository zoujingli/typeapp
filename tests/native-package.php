...
if (in_array('--archive', $argv, true)) {
    // zip 与 tar.gz 各自最多 90 秒，外加解包、清单核对和原生启动；单次 90 秒会在第二份格式上被杀掉。
    $archived = (new Process([PHP_BINARY, $root . '/tests/package-archive.php', $package, $created['manifest-sha256']], $root))->wait(240);
