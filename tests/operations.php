...
$invalidCases = [
    ...
    ['final class Service { #[\\Type\\Orm\\Attribute\\Transactional(connection: "missing")] public function run(int $value): void {} }', '缺失事务连接'],
    ...
    ['final class Service { #[\\Type\\Orm\\Attribute\\Transactional("connection", connection: "connection")] public function run(\\Type\\Orm\\Connection $connection): void {} }', '重复 Attribute 参数'],
