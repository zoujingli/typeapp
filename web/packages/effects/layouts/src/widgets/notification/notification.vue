...
function resolveNoticeIcon(level?: NotificationItem['level']) {
  switch (level) {
    case 'success':
...
function resolveNoticeTone(level?: NotificationItem['level']) {
  switch (level) {
    case 'success':
            ...
            >
              ...
              <span
                ...
                :class="[
                  ...
                  resolveNoticeTone(item.level),
                ]"
              >
                <VbenIcon :icon="resolveNoticeIcon(item.level)" class="size-4" />
              </span>
